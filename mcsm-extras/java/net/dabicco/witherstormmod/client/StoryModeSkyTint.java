...
public final class StoryModeSkyTint {
   ...
   private static final float[] SKY_DAY = new float[]{0.45F, 0.50F, 0.82F}; // soft lavender day (not blown white)
   ...
   private static final float[] HORIZON_DAY = new float[]{0.62F, 0.64F, 0.85F};
