...
public final class McsmStormSkyLayer {
    ...
    public static void submit(LevelRenderContext ctx) {
        try {
            ...
            // vanilla AND FabricSkyBoxes mode. 1.9.313: "no pack owns the
            ...
            // 1.9.313: the alpha patch itself is large enough to sit behind
            ...
            // giant green/purple sphere in the 1.9.313 screenshots and it also
            ...
            // 1.9.313 -- the organic smear: a SEPARATE infinite skybox layer
