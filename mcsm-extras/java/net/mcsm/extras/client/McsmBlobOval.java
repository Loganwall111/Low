...
/**
 * MCSM 1.9.310 -- the Atmospheric W's Cloud for the SHADER-PACK path.
 *
...
public final class McsmBlobOval {
    ...
    public static void submit(LevelRenderContext ctx) {
        try {
            ...
            // 1.9.310: make the alpha patch large enough to sit behind the
            ...
            // 1.9.310: the smear patch, drawn on a camera-centred sky
