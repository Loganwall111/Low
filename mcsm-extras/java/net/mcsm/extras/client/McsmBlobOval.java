...
/**
 * MCSM 1.9.305 -- the infinite skybox smear for the SHADER-PACK path.
 *
...
public final class McsmBlobOval {
    ...
    public static void submit(LevelRenderContext ctx) {
        try {
            ...
            // 1.9.305: the smear patch, drawn on a camera-centred sky
            ...
            final double radius = Math.max(dist, 2.0);
